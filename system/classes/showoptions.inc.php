...
class optionBuilder {
	...
	function showCourses($program, $selected = null) {
		...
		if ($program != null) {
			...
			$sql = "SELECT `ID`, CONCAT (`Name`,' (',`CourseDescription`,')') AS `Name` FROM `courses` ORDER BY `courses`.`Name`";
		}
...
//............................................................summery...............................................................
	...
	function showApplicant($selected = null) {
		...
		$sql = "SELECT ap.applicantno, ap.firstname, ap.lastname, ap.gender, ap.NRCnumber,ap.email, (SELECT s2.name FROM study s2 WHERE ID = ap2.program) as program FROM appl_personal ap, appl_program ap2 " ;
