...
$conf['conf']['path'] = "http://192.168.0.33/sis"; 					// Change to the installation path of Edurole on webserver (example: www.example.com/pathtosystem) would be /pathtosystem.
 ...
 */
$conf['mysql']['server'] = "192.168.0.12"; 					// MySQL server host
...
$conf['sms']['senderid'] = "Mulungushi"; 								//SenderID
$conf['sms']['source'] = "Mulungushi University"; 						// SMS Sender Name
 ...
 */
$conf['conf']['templates'] = array("loanpro");	// Template names in array form
